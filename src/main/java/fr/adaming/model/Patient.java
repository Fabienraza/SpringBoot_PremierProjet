 ...
 *******************************************************/	
	...
	public String toString() {
		return "Patient [idPatient=" + idPatient + ", nomPatient=" + nomPatient + ", prenomPatient=" + prenomPatient + ", dateDeNaissance=" + dateDeNaissance + ", pathologie=" + pathologie + ", medecin=" + medecin + "]";
	}
